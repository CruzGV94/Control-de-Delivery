...
public class HiloIm1 extends Thread implements Serializable{
    ...
    public void run() {
        ...
        ProductosFm.nombre[index] = "Moto1";
        ProductosFm.distancias[index] = String.valueOf(ProductosFm.distancia[0]);
        
        int valorx = Enviar.jLabelim1.getX();
        int valory = Enviar.jLabelim1.getY();
        while (true) {            
            Enviar.jLabelim1.setBounds(valorx, valory, 100, 100);
            valorx = valorx + (5);
            Enviar.jLabelim1.setIcon(new ImageIcon(img5));
            try {
                Thread.sleep(10*ProductosFm.distancia[0]);
        ...
        Enviar.jLabelim1.setIcon(new ImageIcon(img4));
